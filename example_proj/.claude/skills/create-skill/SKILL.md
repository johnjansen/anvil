...
A skill is a `SKILL.md` file inside a `.claude/skills/<skill-name>/` directory. It uses YAML frontmatter:
...
- Created by `anvil init` as part of project setup
...
3. Create the skill:
   - **Project level**: Write to `.claude/skills/<skill-name>/SKILL.md` relative to project root
