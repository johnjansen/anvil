// Download a skill from GitHub into the project's .claude/skills/ directory
...
const targetDir = process.argv[4] || join(process.cwd(), ".claude", "skills");
...
try {
  ...
  const res = await fetch(apiUrl, {
    headers: { "User-Agent": "anvil-skill-installer" },
  });
