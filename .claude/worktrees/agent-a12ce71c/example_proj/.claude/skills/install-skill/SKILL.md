...
Search for skills on skills.sh and install them into the project's `.claude/skills/` directory. Always project level.
...
3. **Install**: Run `install.mjs` with the chosen repo, skill name, and the project's `.claude/skills/` directory path.
